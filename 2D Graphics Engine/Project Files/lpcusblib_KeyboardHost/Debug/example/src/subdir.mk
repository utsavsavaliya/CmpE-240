...
clean-example-2f-src:
	-$(RM) ./example/src/KeyboardHost.d ./example/src/KeyboardHost.o ./example/src/cr_startup_lpc175x_6x.d ./example/src/cr_startup_lpc175x_6x.o ./example/src/sysinit.d ./example/src/sysinit.o
