...
clean-example-2f-src:
	-$(RM) ./example/src/clkout.d ./example/src/clkout.o ./example/src/cr_startup_lpc175x_6x.d ./example/src/cr_startup_lpc175x_6x.o ./example/src/sysinit.d ./example/src/sysinit.o
